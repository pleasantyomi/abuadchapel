    ...
    <div>
      <div className="bg-primary-Black w-full py-10">
            ...
            {EventList.map((event, index) => (
              <div key={index} className="lg:flex grid lg:gap-4 gap-3">
                <Image
                  ...
                  width={750}
                  height={750}
                  className="rounded-2xl lg:w-6/12 w-full h-[40vh] object-cover flex-shrink-0 flex-nowrap"
                />
        ...
        <div className="flex items-center justify-center lg:gap-3 gap-2">
          ...
          <button className="flex items-center gap-2 text-green-500 border-[1px] border-green-500 rounded-full lg:py-3 py-2 px-3 lg:px-4">
